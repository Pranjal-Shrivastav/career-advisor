...
const ITEMS: Item[] = [
  {
    title: "State Engineering Entrance Application Opens",
    date: "2025-10-01",
    type: "admission",
    org: "State Board",
  },
  {
    title: "National Scholarship (Merit) Deadline",
    date: "2025-11-15",
    type: "scholarship",
    org: "Govt. of India",
  },
  {
    title: "Polytechnic Admissions Round 1",
    date: "2025-08-20",
    type: "admission",
    org: "DTE",
  },
  {
    title: "Arts & Humanities Scholarship Results",
    date: "2025-09-05",
    type: "scholarship",
    ...
    <div className="container mx-auto max-w-3xl px-4 py-10">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">
          Admission dates and scholarship deadlines in a simple timeline.
        </p>
      </div>
                ...
                <div className="md:grid md:grid-cols-2 md:gap-6">
                  ...
                  <div className="md:col-start-2 md:mr-auto">
                    <div className="relative rounded-2xl border bg-card p-5 shadow-sm">
                      <div
                        className="absolute left-3 -top-3 inline-flex items-center gap-2 rounded-full px-2 py-1 text-xs font-medium md:left-6"
                        style={{}}
                      >
                        <span className={badgeStyles[it.type]}>
                          {it.type === "admission"
                            ? "Admission"
                            : "Scholarship"}
                        </span>
